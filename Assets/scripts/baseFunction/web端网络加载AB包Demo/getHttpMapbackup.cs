...
public class getHttpMapbackup : MonoBehaviour
{
    ...
    IEnumerator getMaps(){
        // string url = "http://127.0.0.1:5501/AssetBundles/StandaloneWindows64/buildingmodel";        
        ...
        // string pathUrl = "https://10.56.21.135/scf/static/unity3d_2024/StreamingAssets/WebGL/";
        ...
        // string url = "http://127.0.0.1:5501/Assets/StreamingAssets/WebGL/dahuamap";
        // WWW w = new WWW(url);
        // yield return w;
        // // Debug.Log(w);
        // Debug.Log("success");
    ...
    IEnumerator getMaps2(){
        string url = "http://127.0.0.1:5501/StreamingAssets/dahuamate";           
        WWW w = new WWW(url);
        yield return w;
        // Debug.Log(w);
        Debug.Log("success");
