...
public class cameraPosition1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        transform.RotateAround(LookAtCube.transform.position, Vector3.right, 35);
    ...
    void Update()
    {
        ...
        if ( true)
        {
            ...
            // LookAtCube.transform.position += moveDir * moveSpeed * Time.deltaTime;
    ...
    public void Cam_Ctrl_Rotation()
    {
        ...
        {
            transform.RotateAround(LookAtCube.transform.position, Vector3.up, mouse_x * 20);
            transform.RotateAround(LookAtCube.transform.position, transform.right, mouse_y * 20);

            // 旋转 Cube

            LookAtCube.transform.Rotate(Vector3.up, mouse_x * 20);
    ...
    private void MoveCameraSideways(float mouseX)
    {
        ...
        // Rotion_Transform = (Vector3.right * 100 * Time.deltaTime * -mouseX);
    ...
    private void MoveCameraUpwards(float mouseY)
    {
        ...
        // Rotion_Transform = (Vector3.up * 100 * Time.deltaTime * -mouseY);
        ...
        LookAtCube.transform.position = LookAtCube.transform.position + LookAtCube.transform.forward * 100 * Time.deltaTime * -mouseY; 
