...
public class loadABDemo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // string terrain = "Assets/resources/Terrain.prefab";
        // name = "Assets/dahuyuahqu 1.fbx";

        // GameObject terrainObj = ABManager.GetInstance().LoadRes("terrain", terrain) as GameObject;
        // terrainObj.transform.position = new Vector3(-2701f, -0.1f, -2529f);
